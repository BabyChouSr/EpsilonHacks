...
def runOutput(inp):
    if ("view" in inp):
        names = ["Isabella's", "Compass Arizona Grill", "Orange Sky"]
        descriptions = ["Kitchen Bars, Nightlife, Beer, Flowers, Pretty","Wine & Spirits, Italian, Food , Restaurants Nightlife, Exotic", "Seafood, Steakhouses, Steak, American, Fancy"]
    if ("food" in inp):
        names = ["Kai Restaurant", "True Food Kitchen", "Rito's Mexican Food"]
        descriptions = ["Fine Dining, 24/7, Wine, Special, High-Class","Vegan Food, International, Wine, Restaurants, Delicious", "Mexican Cuisine, Burritos, Chimmichangas, Restaurant, Yummy"]
